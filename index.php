...
<div class="fill-0">
  <div class="container">
    ...
    <div class="research">
      ...
      <div class="row">
        <div class="col-sm"><img src="./image/index/r0.jpg" alt=""><br><p>Polarization studies</p></div>
        <div class="col-sm"><img src="./image/index/r1.png" alt=""><br><p>Weak measurment</p></div>
</div>
<div class="row">
        <div class="col-sm"><img src="./image/index/r2.png" alt=""><br><p>Nano-optics</p></div>
        <div class="col-sm"><img src="./image/index/r3.png" alt=""><br><p>Computational optics</p></div>
      </div>
    </div>    
  </div>
</div>
