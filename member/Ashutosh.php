    ...
    <div class="container">
        <div class="member">
            ...
            <div class="info">
                <div class="row">
                    <div class="col-sm">
                        <div class="name">S Ashutosh, <span>BS-MS</span></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm email">
                        <div class="value"><a href="mailto:sa17ms105@iiserkol.ac.in,">sa17ms105@iiserkol.ac.in,</a></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm webpage">
                        <div class="value"><a href="https://students.iiserkol.ac.in/~sa17ms105">sa17ms105</a></div>
                    </div>
                    <div class="row">
                        <div class="col-sm">
