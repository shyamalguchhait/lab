    ...
    <div class="container">
        <div class="member">
            <div class="bg-img">
                <div class="row"> 
                    <div class="col-sm">
                        <div class="pf-img"><img src="../image/members/img_Athira B S.jpg" alt="Athira B S"></div>
                    </div>
                </div>
            </div>
            <div class="info">
                ...
                <div class="row">
                    ...
                    <div class="col-sm email">
                        <div class="value"><a href="mailto:abs16rs013@iiserkol.ac.in">abs16rs013@iiserkol.ac.in</a></div>
                    </div>
                </div>
                <div class="row">
