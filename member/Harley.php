    ...
    <div class="container">
        <div class="member">
            <div class="bg-img">
                <div class="row">
                    <div class="col-sm">
                        <img src="../image/members/img_Harley Suchiang.jpg" alt="Harley Suchiang">
                    </div>
                </div>
            </div>
            <div class="info">
                <div class="row">
                    <div class="col-sm">
                        <div class="name">Harley Suchiang, <span>BS-MS</span></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm email">
                        <div class="value"><a href="mailto:hs16ms002@iiserkol.ac.in">hs16ms002@iiserkol.ac.in</a></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="fill">Harley currently pursuing Integrated BS-MS Dual Degree program at the Department of Physical Sciences, IISER-K. His research interests include spin-orbit interaction of light in metasurface.</div>
                        </div>
                    </div>
                </div>
            </div>
