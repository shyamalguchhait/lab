    ...
    <div class="container">
        <div class="member">
            ...
            <div class="info">
                <div class="row">
                    <div class="col-sm">
                        <div class="name">Himanshu, <span>BS-MS</span></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm email">
                        <div class="value"><a href="mailto:h17ms042@iiserkol.ac.in,">h17ms042@iiserkol.ac.in,</a></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm webpage">
                        <div class="value"><a href="https://students.iiserkol.ac.in/~h17ms042">h17ms042</a></div>
                    </div>
                    <div class="row">
                        <div class="col-sm">
