    ...
    <div class="container">
        <div class="member">
            <div class="bg-img">
                <div class="row">
                    <div class="col-sm">
                        <img src="../image/members/img_Priyanuj Bordoloi.jpg" alt="Priyanuj Bordoloi">
                    </div>
                </div>
            </div>
            <div class="info">
                <div class="row">
                    <div class="col-sm">
                        <div class="name">Priyanuj Bordoloi, <span>BS-MS</span></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm email">
                        <div class="value"><a href="mailto:pb17ms094@iiserkol.ac.in,">pb17ms094@iiserkol.ac.in,</a></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm webpage">
                        <div class="value"><a href="https://students.iiserkol.ac.in/~pb17ms094">pb17ms094</a></div>
                    </div>
                    <div class="row">
                        <div class="col-sm">
                            <div class="fill">Atharva is currently pursuing Integrated BS-MS Dual Degree program at the Department of Physical Sciences, INSPIRE  Fellow. His research interestsinclude orbital angular momentum and polarization to probe the properties of turbid media.</div>
                        </div>
                    </div>
                </div>
            </div>
